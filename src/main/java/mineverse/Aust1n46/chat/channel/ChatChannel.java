...
public class ChatChannel {
    ...
    private String firstFormat, secondFormat;
    ...
    public ChatChannel(String name, String color, String chatColor, String permission, String speakPermission,
                       ...
                       boolean bungee, int cooldown, String prefix, String firstFormat, String secondFormat) {
        this.name = name;
        this.color = color;
    ...
    public ChatChannel(String name, String color, String chatColor, String permission, String speakPermission,
                       Boolean mutable, Boolean filter, Boolean defaultChannel, String alias, Double distance, Boolean autojoin,
                       Boolean bungee, int cooldown, String firstFormat, String secondFormat) {
        this.name = name;
        this.color = color;
        this.chatColor = chatColor;
        this.permission = PERMISSION_PREFIX + permission;
    ...
    public static void initialize() {
        ...
        for (String key : cs.getKeys(false)) {
            ...
            String firstFormat = cs.getString(key + ".first_format", "Default");
            String secondFormat = cs.getString(key + ".second_format", "Default");
            ...
            ChatChannel chatChannel = new ChatChannel(name, color, chatColor, permission, speakPermission, mutable,
                filter, defaultChannel, alias, distance, autojoin, bungee, cooldown, prefix, firstFormat, secondFormat);
        ...
        if (defaultChatChannel == null) {
            ...
            defaultChatChannel = new ChatChannel("MissingDefault", "red", "red", "None", "None", false,
                true, true, "md", 0, true, false, 0, "&f[&cMissingDefault&f]", "{venturechat_channel_prefix} {vault_prefix}{player_displayname}&c:", "&f{player_meessage}");
    ...
    /**
     * Get the first line format of the chat channel.
     *
     * @return {@link String}
     */
    ...
    /**
     * Get the second line format of the chat channel.
     *
     * @return {@link String}
     */
