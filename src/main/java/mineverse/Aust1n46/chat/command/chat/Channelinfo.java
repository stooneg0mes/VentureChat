...
public class Channelinfo extends Command {
    ...
    public boolean execute(CommandSender sender, String command, String[] args) {
        if (sender.hasPermission("venturechat.channelinfo")) {
            ...
            sender.sendMessage(ChatColor.GOLD + "First line format: " + chname.getColor() + chname.getFirstFormat());
            sender.sendMessage(ChatColor.GOLD + "Second line format: " + chname.getColor() + chname.getSecondFormat());
            return true;
        } else {
